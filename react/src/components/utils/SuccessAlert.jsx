...
const SuccessAlert = ({ title, message, onClick, button, onDismiss }) => {
  return (
      ...
      <div id="alert-additional-content-3" className="p-4 mb-4 text-green-800 border border-green-300 rounded-lg bg-green-50" role="alert">
        ...
        <div className="flex">
          {button !== false && (
            ...
            <button onClick={onClick} type="button" className="text-white bg-green-800 hover:bg-green-900 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-xs px-3 py-1.5 mr-2 text-center inline-flex items-center">
